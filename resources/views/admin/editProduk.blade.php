...
<head>
    <meta charset="UTF-8">
    <title>Edit Produk - Cloth Studio</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Edit produk: {{ $product->nama_produk }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form action="{{ url('/admin/produk/' . $product->produk_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="file" 
                               ...
                               accept="image/*"
                               class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-500">
                        <p class="text-xs text-gray-500 mt-1">Pilih file gambar dari device (JPG, PNG, GIF). Kosongkan jika tidak ingin mengubah gambar.</p>
                        @if($product->gambar_produk)
                            <p class="text-xs text-gray-500 mt-1">Gambar saat ini: {{ $product->gambar_produk }}</p>
                        @endif
                    </div>
                </div>
